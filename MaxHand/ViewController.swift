...
//            }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let houseScene = SCNScene(named: "art.scnassets/character/testanimation.dae")
        let houseNode = houseScene?.rootNode.childNode(withName: "threesquare", recursively: true)
